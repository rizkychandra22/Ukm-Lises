        ...
        <div className="space-y-5 text-muted-foreground">
          <p>
            <span className="font-semibold text-foreground">
              UKM Lises Asmarandana
            </span>{" "}
            adalah Unit Kegiatan Mahasiswa di bidang seni musik dan tari di
            Universitas Muhammadiyah Sukabumi. Nama <em>Asmarandana</em> diambil
            dari salah satu tembang Sunda yang sarat makna, cinta pada budaya,
            dan keindahan.
          </p>
          <p>
            Sejak berdiri, UKM ini menjadi ruang bertumbuh bagi mahasiswa yang
            ingin belajar gamelan, kacapi suling, jaipong, tari kreasi, dan
            berbagai bentuk pertunjukan tradisional maupun kontemporer.
          </p>
          <p>
            Setiap tahun, Lises Asmarandana tampil di acara kampus, festival
            budaya, dan pementasan kolaboratif bersama komunitas seni lain.
          </p>
        </div>
      </section>
