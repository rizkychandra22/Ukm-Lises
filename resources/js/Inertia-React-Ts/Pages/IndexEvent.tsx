                  ...
                  {filteredEvents.length === 0 ? (
                    ...
                    filteredEvents.map((item) => (
                      <TableRow key={item.id} className="transition-colors">
                        ...
                        <TableCell className="text-sm font-medium">
                          {item.ticket
                            ? `${item.remaining_tickets ?? item.ticket} / ${item.ticket}`
                            : "Unlimited"}
                        </TableCell>
                        <TableCell>
                          <span
