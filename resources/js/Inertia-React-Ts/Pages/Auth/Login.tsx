      ...
      <div className="hidden lg:flex w-[50%] bg-gradient-gold p-8 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 max-w-md">
          ...
          <p className="text-ink/80 text-base leading-relaxed">
            Kelola data anggota, pantau agenda kegiatan latihan, tangani persetujuan acara, dan
            awasi inventaris — semuanya dalam satu tempat.
          </p>
        ...
        <div className="w-full max-w-[360px]">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground text-xs">
              Silahkan login untuk management internal
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="captcha">
                Captcha <span className="text-destructive">*</span>
              </Label>
                  ...
                  <div className="absolute inset-0">
                    ...
                    >
                      <g stroke="#537b75" strokeWidth="1.5" strokeLinecap="round">
                        {/* Noise lines */}
                        <path
                          d="M 10 20 Q 30 45 60 35 T 115 15"
                          fill="none"
                          strokeDasharray="2,3"
                        />
                      ...
                      <text
                        ...
                        transform="rotate(-5 60 24) skewX(10)"
                      >
                        {captchaCode}
                      </text>
                    </svg>
