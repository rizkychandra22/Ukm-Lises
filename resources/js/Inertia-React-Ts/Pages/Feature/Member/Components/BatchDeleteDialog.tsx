...
export function BatchDeleteDialog({ isOpen, onOpenChange, onConfirm }: BatchDeleteDialogProps) {
  return (
      ...
      <AlertDialogContent className="w-[90%] max-w-[360px] rounded-md p-6">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-center text-[14px] mt-2 mb-4 text-foreground/80">
            Yakin ingin menghapus data angkatan ini? Semua anggota di dalamnya akan terpengaruh.
          </AlertDialogDescription>
        </AlertDialogHeader>
