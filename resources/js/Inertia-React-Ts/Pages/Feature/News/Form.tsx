                ...
                <div className="bg-card border rounded-xl overflow-hidden shadow-sm">
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea 
                                        ...
                                        className="h-20"
                                    />
                                    {errors.summary_id && <span className="text-xs text-destructive">{errors.summary_id}</span>}
                                </div>
                            </div>

                            {/* Kanan: Foto */}
                            <div className="space-y-2">
                                <Label>Foto Utama (Cover) {isEdit && <span className="text-muted-foreground text-xs font-normal ml-2">(Kosongkan jika tidak diubah)</span>}</Label>
                                <div className="border-2 border-dashed border-border rounded-xl flex flex-col items-center justify-center p-6 bg-muted/20 relative group h-[278px]">
                                    {imagePreview ? (
                                        <>
                                            <img src={imagePreview} alt="Preview" className="w-full h-full object-cover rounded-lg absolute inset-0" />
                                        ...
                                        <Label htmlFor="image-upload" className="cursor-pointer flex flex-col items-center justify-center text-center">
                                            ...
                                            <span className="text-xs text-muted-foreground mt-1">Maks. 10MB (JPG, PNG, WEBP)</span>
                                        </Label>
                                    )}
                                    <Input 
                                        id="image-upload" 
                        ...
                        <div className="space-y-2 pt-4 border-t border-border">
                            ...
                            />
                            {errors.description_id && <span className="text-xs text-destructive">{errors.description_id}</span>}
                        </div>
